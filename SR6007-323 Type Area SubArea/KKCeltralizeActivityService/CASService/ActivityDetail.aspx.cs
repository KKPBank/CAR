    ...
    public partial class ActivityDetail : System.Web.UI.Page
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            try
			{
                log.Debug("OnInit");
                base.OnInit(e);
                Appz.BuildCombo(cmbSSubscriptionType, "CAS_SUBSCRIPTION_TYPE", "SUBSCRIPTION_TYPE_NAME", "SUBSCRIPTION_TYPE_ID", "", "", "ระบุประเภทบุคคล", "0", false);
        ...
        protected void BtnSearch_Click(object sender, EventArgs e)
        {
            ...
            else
	        {
	            try 
				{
	                ...
	                inq.SubscriptionTypeID = Appz.SafeDecimal(cmbSSubscriptionType.SelectedValue);
	                ...
	                if (!String.IsNullOrEmpty(inq.SubscriptionID) && inq.SubscriptionTypeID == 0)
