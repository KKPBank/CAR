...
namespace Cas.Dal
{
    ...
    public partial class KKCASModel : DbContext
    {
        public KKCASModel()
            : base("name=KKCASModel")
        {
        }
        ...
        public virtual int SP_SEQ_CAR_BATCH_LOG_ID(ObjectParameter oUTSEQ)
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_SEQ_CAR_BATCH_LOG_ID", oUTSEQ);
        }
    
        public virtual int SP_SEQ_CAR_BATCH_LOG_DETAIL_ID(ObjectParameter oUTSEQ)
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_SEQ_CAR_BATCH_LOG_DETAIL_ID", oUTSEQ);
        }
    }
}
