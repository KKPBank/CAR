...
namespace KKCAR.Business
{
    public class StatusFacade : IStatusFacade
    {
        ...
        public InsertStatusResponse InsertStatus(InsertStatusRequest request, bool skipValidate, bool skipValidateCustType)
        {
            ...
            else
            {
                ...
                if (string.IsNullOrWhiteSpace(request.RefSystemCode))
                {
                    valid = false;
            ...
            try
            {
                ...
                if (reqList.Any())
                {
                    ...
                    for (int i = 0; i < totalRecords; i++)
                    {
                        ...
                        var res = this.InsertStatus(req, true,false);
