...
namespace KKCAR.WCFService
{
    ...
    public interface IKKCARBatchStatusService : IDisposable
    {
        ...
        //[OperationContract]
        //[WebInvoke(Method = "GET", BodyStyle = WebMessageBodyStyle.WrappedRequest,
        //    RequestFormat = WebMessageFormat.Xml, ResponseFormat = WebMessageFormat.Xml, UriTemplate = "BatchInsertStatusByText")]
        //TaskInsertStatusResponse BatchInsertStatusByText();

        //[OperationContract]
        //[WebInvoke(Method = "POST", BodyStyle = WebMessageBodyStyle.WrappedRequest,
        //    RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json, UriTemplate = "CARInsertStatusByExcel")]
        //TaskInsertStatusResponse InsertStatusByExcel(string username, string password);

        //[OperationContract]
        //[WebInvoke(Method = "POST", BodyStyle = WebMessageBodyStyle.WrappedRequest,
        //    RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json, UriTemplate = "BatchCARInsertStatusByExcel")]
        //TaskInsertStatusResponse BatchInsertStatusByExcel(string username, string password);
    }
}
